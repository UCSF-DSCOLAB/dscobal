...
const CONFIGS = {
  ...
  midnight: {
    ...
    tvel:0.3,
    texp:180,
    color:"midnightblue black",
    wcolors:"1,black 1,#207",
    stroke:"gray",
    ttxt:"DSCOLAB",
    tcol:"#0ff",
    tfont:"70px serif"
  ...
  easter: {
    ...
    tvel:-1.5,
    texp:333,
    color:"#ffb5e8 #b28dff #dcd3ff #aff8db #bffcc6 #ffc9de #ff9cee #c5a3ff #a79aff #c4faf8 #dbffd6 #ffabab #ffccf9 #d5aaff #b5b9ff #85e3ff #f3ffe3 #ffbebc #fcc2ff #ecd4ff #97a2ff #ace7ff #e7ffac #ffcbc1",
    wcolors:"1,yellow 10,skyblue",
    stroke:"#88f",
    ttxt:"🐰D🌼S🐤C🌸O🥚L🐣A🌱B",
    tcol:"purple",
    tfont:"bold 90px serif"
  ...
  violet: {
    ...
    tvel:1,
    texp:180,
    color:"lavender thistle plum violet orchid fuchsia magenta mediumorchid mediumpurple blueviolet darkviolet darkorchid darkmagenta purple indigo",
    wcolors:"100,black 1,white",
    stroke:"darkgoldenrod",
    ttxt:"DSCOLAB",
    tcol:"white",
    tfont:"50px sans-serif"
  },
  beach: {
    wvel:0.1,
    wcx:1200,
